...
var omxdirector = function () {
    ...
    var videoDir = '/mnt/stockage/movies'; // MN: Raspberry Pi Stockage
    var videoSuffix = '';
    ...
    var open = function (videos, options) {
        ...
        if (settings.timeStart) {
            args.push('--pos');
            args.push(settings.timeStart);
        }

        args.push('--display=5'); // Force display to HDMI output
